...
export default function RewardsPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">Rewards Tracker</h1>
        <p className="text-gray-400 mt-1">Track your crypto rewards across all your cards</p>
      </div>
      ...
      <div className="text-center py-16 bg-gray-900 border border-gray-800 rounded-xl">
        ...
        <div className="flex justify-center gap-4">
          ...
          <Link
            href="/cards"
            className="px-6 py-3 border border-gray-700 hover:border-gray-600 text-white rounded-lg font-medium transition-colors"
          >
            Browse Cards
          </Link>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
          <div className="w-10 h-10 bg-lime-500/20 rounded-lg flex items-center justify-center mb-4">
            <svg className="w-5 h-5 text-lime-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
            </svg>
          </div>
          <h4 className="text-white font-medium mb-2">Log Rewards</h4>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
          ...
          <h4 className="text-white font-medium mb-2">Track Value</h4>
          <p className="text-sm text-gray-500">
